    ...
    for category in category_dict:
        ...
        for group_name in groups_dict:
            ...
            for node in groups_dict[group_name]:
                ...
                # TODO - in desc field need to substitute <varname> and </varname>
                # markup with an html span element that styles to blue
                # this is currently in the the cam namelist_definition.xml file
                if schema == "new":
